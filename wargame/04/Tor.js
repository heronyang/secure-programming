! function(e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            var i, o, a = it.expando,
                ...
                u = s ? it.cache : e,
                l = s ? e[a] : e[a] && a;
            if (l && u[l] && (r || u[l].data) || void 0 !== n || "string" != typeof t) return l || (l = s ? e[a] = G.pop() || it.guid++ : a), u[l] || (u[l] = s ? {} : {
                toJSON: it.noop
    ...
    function j(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = it._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && jt(r) && (o[a] = it._data(r, "olddisplay", C(r.nodeName)))) : (i = jt(r), (n && "none" !== n || !i) && it._data(r, "olddisplay", i ? n : it.css(r, "display"))));
    ...
    function M(e, t, n) {
        ...
        if (it.isEmptyObject(f)) "inline" === ("none" === l ? C(e.nodeName) : l) && (p.display = l);
        else {
    ...
    function R(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = hn || _(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
    ...
    var lt = function(e) {
            ...
            if (q && !r) {
                ...
                if (w.qsa && (!F || !F.test(e))) {
                    if (p = d = B, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (l = C(e), (d = t.getAttribute("id")) ? p = d.replace(xt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = l.length; u--;) l[u] = p + f(l[u]);
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, l) {
                    var c, d, f, p = 0,
                        ...
                        w = b.length;
                    for (l && (j = a !== H && a); h !== w && null != (c = b[h]); h++) {
                        if (o && c) {
                            for (d = 0; f = e[d++];)
                                if (f(c, a, s)) {
                                    u.push(c);
        ...
        var x, w, T, E, k, C, N, S, j, A, D, L, H, _, q, F, M, O, R, B = "sizzle" + -new Date,
            P = e.document,
            I = 0,
            W = 0,
            $ = n(),
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, _ = n.documentElement, q = !k(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
            ...
            })), (w.matchesSelector = vt.test(O = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && i(function(e) {
                w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), M.push("!=", st)
            }), F = F.length && new RegExp(F.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(_.compareDocumentPosition), R = t || vt.test(_.contains) ? function(e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === P && R(P, e) ? -1 : t === n || t.ownerDocument === P && R(P, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & r ? -1 : 1)
            } : function(e, t) {
                if (e === t) return D = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && L(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !q || M && M.test(n) || F && F.test(n))) try {
                var r = O.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[B] || (g[B] = {}), l = c[e] || [], p = l[0] === I && l[1], f = l[0] === I && l[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++f && d === t) {
                                        c[e] = [I, p, f];
                                        break
                                    }
                            } else if (y && (l = (t[B] || (t[B] = {}))[e]) && l[0] === I) f = l[1];
                            else
                                for (;
        ...
        add: function(e, t, n, r, i) {
            ...
            if (g) {
                for (n.handler && (u = n, n = u.handler, i = u.selector), n.guid || (n.guid = it.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
                    ...
                    }, c.elem = e), t = (t || "").match(bt) || [""], s = t.length; s--;) o = Ft.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (l = it.event.special[p] || {}, p = (i ? l.delegateType : l.bindType) || p, l = it.event.special[p] || {}, d = it.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(bt) || [""], l = t.length; l--;)
                    if (s = Ft.exec(t[l]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
    ...
    Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
        clone: function(e, t, n) {
            ...
            if (nt.html5Clone || it.isXMLDoc(e) || !Rt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Kt.innerHTML = e.outerHTML, Kt.removeChild(o = Kt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), u = (It.exec(o) || ["", ""])[1].toLowerCase(), c = Yt[u] || Yt._default, s.innerHTML = c[1] + o.replace(Pt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, s = it.expando, u = it.cache, l = nt.deleteExpando, c = it.event.special; null != (n = e[a]); a++)
                if ((t || it.acceptData(n)) && (i = n[s], o = i && u[i])) {
                    ...
                    u[i] && (delete u[i], l ? delete n[s] : typeof n.removeAttribute !== Et ? n.removeAttribute(s) : n[s] = null, G.push(i))
                }
        }
    }), it.fn.extend({
        text: function(e) {
        ...
        html: function(e) {
            return At(this, function(e) {
                ...
                if (!("string" != typeof e || zt.test(e) || !nt.htmlSerialize && Rt.test(e) || !nt.leadingWhitespace && Bt.test(e) || Yt[(It.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Pt, "<$1></$2>");
                    try {
        ...
        domManip: function(e, t) {
            ...
            if (l && (s = it.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                ...
                if (i)
                    for (a = o[o.length - 1].ownerDocument, it.map(o, x), u = 0; i > u; u++) r = o[u], Ut.test(r.type || "") && !it._data(r, "globalEval") && it.contains(a, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Gt, "")));
                s = n = null
            }
            return this
        }
    ...
    it.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(bt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? Sn && Nn || !Cn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(Nn ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return t === !1 ? it.removeAttr(e, n) : Sn && Nn || !Cn.test(n) ? e.setAttribute(!Nn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, it.each(it.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = kn[t] || it.find.attr;
        kn[t] = Sn && Nn || !Cn.test(t) ? function(e, t, r) {
            var i, o;
    ...
    qn = Wn.exec(Fn.toLowerCase()) || [], it.extend({
        ...
        ajax: function(e, t) {
            function n(e, t, n, r) {
                var i, c, v, y, x, T = t;
                2 !== b && (b = 2, s && clearTimeout(s), l = void 0, a = r || "", w.readyState = e > 0 ? 4 : 0, i = e >= 200 && 300 > e || 304 === e, n && (y = W(d, w, n)), y = $(d, y, w, i), i ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (it.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (it.etag[o] = x)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, i = !v)) : (v = T, (e || !T) && (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", i ? h.resolveWith(f, [c, T, w]) : h.rejectWith(f, [w, T, v]), w.statusCode(g), g = void 0, u && p.trigger(i ? "ajaxSuccess" : "ajaxError", [w, d, i ? c : v]), m.fireWith(f, [w, T]), u && (p.trigger("ajaxComplete", [w, d]), --it.active || it.event.trigger("ajaxStop")))
            }
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || Fn) + "").replace(Mn, "").replace(In, qn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""], null == d.crossDomain && (r = Wn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), P($n, d, t, w), 2 === b) return w;
...
function() {
    var e, t, n, r, i, o, a, s, u, l, c, d, f, p, h, m, g, v, y, b, x, w, T, E, k, C, N, S, j, A, D, L, H, _, q, F, M, O, R, B, P, I, W, $, z, X, U, V, G, Y, J, K = [].indexOf || function(e) {
            for (var t = 0, n = this.length; n > t; t++)
        ...
        Z = function(e, t) {
            ...
            for (var r in t) Q.call(t, r) && (e[r] = t[r]);
            return n.prototype = t.prototype, e.prototype = new n, e.__super__ = t.prototype, e
        },
        et = [].slice;
    A = {}, d = 10, X = !1, m = null, S = null, F = null, h = null, Y = null, b = function(e) {
        var t;
        return e = new n(e), P(), c(), X && (t = U(e.absolute)) ? (x(t), w(e)) : w(e, $)
    }, U = function(e) {
        var t;
        return t = A[e], t && !t.transitionCacheDisabled ? t : void 0
    }, g = function(e) {
        ...
        return null == t && (t = function() {
            ...
            url: e.absolute
        }), null != Y && Y.abort(), Y = new XMLHttpRequest, Y.open("GET", e.withoutHashForIE10compatibility(), !0), Y.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"), Y.setRequestHeader("X-XHR-Referer", F), Y.onload = function() {
            var n;
            return V("page:receive", {
                url: e.absolute
            }), (n = _()) ? (M(e), f.apply(null, y(n)), j(), O(), t(), V("page:load")) : document.location.href = e.absolute
        ...
        return null != Y && Y.abort(), f(e.title, e.body), q(e), V("page:restore")
    }, c = function() {
        var e;
        return e = new n(m.url), A[e.absolute] = {
            url: e.relative,
            body: document.body,
        ...
        var t, n, r, i, o, a;
        for (r = Object.keys(A), t = r.map(function(e) {
                return A[e].cachedAt
            }).sort(function(e, t) {
                return t - e
            }), a = [], i = 0, o = r.length; o > i; i++) n = r[i], A[n].cachedAt <= t[e] && (V("page:expire", A[n]), a.push(delete A[n]));
        return a
    }, f = function(t, n, r, i) {
        return document.title = t, document.documentElement.replaceChild(n, document.body), null != r && e.update(r), z(), i && v(), m = window.history.state, V("page:change"), V("page:update")
    }, v = function() {
        ...
        for (o = Array.prototype.slice.call(document.body.querySelectorAll('script:not([data-turbolinks-eval="false"])')), a = 0, u = o.length; u > a; a++)
            if (i = o[a], "" === (c = i.type) || "text/javascript" === c) {
                for (t = document.createElement("script"), d = i.attributes, s = 0, l = d.length; l > s; s++) e = d[s], t.setAttribute(e.name, e.value);
                t.appendChild(document.createTextNode(i.innerHTML)), r = i.parentNode, n = i.nextSibling, r.removeChild(i), r.insertBefore(t, n)
            }
    }, I = function(e) {
        ...
        return (e = new n(e)).absolute !== F ? window.history.pushState({
            turbolinks: !0,
            url: e.absolute
        }, "", e.absolute) : void 0
    }, O = function() {
        var e, t;
        return (e = Y.getResponseHeader("X-XHR-Redirected-To")) ? (e = new n(e), t = e.hasNoHash() ? document.location.hash : "", window.history.replaceState(m, "", e.href + t)) : void 0
    }, P = function() {
        ...
        return t = function() {
            var e;
            return 400 <= (e = Y.status) && 600 > e
        }, o = function() {
            return Y.getResponseHeader("Content-Type").match(/^(?:text\/html|application\/xhtml\+xml|application\/xml)(?:;|$)/)
        }, r = function(e) {
            var t, n, r, i, o;
            for (i = e.head.childNodes, o = [], n = 0, r = i.length; r > n; n++) t = i[n], null != ("function" == typeof t.getAttribute ? t.getAttribute("data-turbolinks-track") : void 0) && o.push(t.getAttribute("src") || t.getAttribute("href"));
            return o
        }, e = function(e) {
            var t;
            return S || (S = r(document)), t = r(e), t.length !== S.length || i(t, S).length !== S.length
        }, i = function(e, t) {
            var n, r, i, o, a;
            for (e.length > t.length && (o = [t, e], e = o[0], t = o[1]), a = [], r = 0, i = e.length; i > r; r++) n = e[r], K.call(t, n) >= 0 && a.push(n);
            return a
        }, !t() && o() && (n = h(Y.responseText), n && !e(n)) ? n : void 0
    }, y = function(t) {
        var n;
        return n = t.querySelector("title"), [null != n ? n.textContent : void 0, I(t.body), e.get(t).token, "runScripts"]
    }, e = {
        get: function(e) {
            var t;
        ...
        try {
            if (window.DOMParser) return i = t("<html><body><p>test"), t
        } catch (a) {
            return r = a, i = e("<html><body><p>test"), e
        } finally {
        ...
        return Z(t, e), t.HTML_EXTENSIONS = ["html"], t.allowExtensions = function() {
            var e, n, r, i;
            for (n = 1 <= arguments.length ? et.call(arguments, 0) : [], r = 0, i = n.length; i > r; r++) e = n[r], t.HTML_EXTENSIONS.push(e);
        ...
        function e(e) {
            this.event = e, this.event.defaultPrevented || (this._extractLink(), this._validForTurbolinks() && (D() || G(this.link.href), this.event.preventDefault()))
        }
        ...
        return "undefined" != typeof jQuery ? jQuery(document).on("ajaxSuccess", function(e, t) {
            return jQuery.trim(t.responseText) ? V("page:update") : void 0
        }) : void 0
    }, C = function(e) {
        var t, r;
        return (null != (r = e.state) ? r.turbolinks : void 0) ? (t = A[new n(e.state.url).absolute]) ? (c(), x(t)) : G(e.target.location.href) : void 0
    }, E = function() {
        return B(), R(), h = i(), document.addEventListener("click", t.installHandlerLast, !0), window.addEventListener("hashchange", function() {
            return B(), R()
        }, !1), l(function() {
            return window.addEventListener("popstate", C, !1)
        })
    }, T = void 0 !== window.history.state || navigator.userAgent.match(/Firefox\/2[6|7]/), s = window.history && window.history.pushState && window.history.replaceState && T, o = !navigator.userAgent.match(/CriOS\//), W = "GET" === (J = H("request_method")) || "" === J, u = s && o && W, a = document.addEventListener && document.createEvent, a && (k(), N()), u ? (G = b, E()) : G = function(e) {
